...
const agencySchema = Yup.object({
  name: Yup.string().required("Agency name is required").min(2, "Name must be at least 2 characters"),
...
const mockAgency = {
  ...
  description: "Leading education consultancy helping students achieve their dreams",
  address: "123 Education Street, Tokyo, Japan",
  facebook_url: "https://facebook.com/globaledu",
  message_from_director: "We are committed to providing the best educational guidance.",
  services_offered: "Study abroad consulting, visa assistance, scholarship guidance",
  is_deleted: false,
    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Update agency information and details</p>
        </div>
      </div>
        ...
        <CardContent>
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className={formik.touched.contact_email && formik.errors.contact_email ? "border-red-500" : ""}
                  />
                  {formik.touched.contact_email && formik.errors.contact_email && (
                    <p className="text-sm text-red-500">{formik.errors.contact_email}</p>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className={formik.touched.facebook_url && formik.errors.facebook_url ? "border-red-500" : ""}
                  />
                  {formik.touched.facebook_url && formik.errors.facebook_url && (
                    <p className="text-sm text-red-500">{formik.errors.facebook_url}</p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  className={formik.touched.established_year && formik.errors.established_year ? "border-red-500" : ""}
                />
                {formik.touched.established_year && formik.errors.established_year && (
                  <p className="text-sm text-red-500">{formik.errors.established_year}</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="message_from_director">Message from Director</Label>
                <Textarea
